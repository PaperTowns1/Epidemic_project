#ifndef EPIDEMIC_SIR_2_DISPLAY_HPP
#define EPIDEMIC_SIR_2_DISPLAY_HPP

#include <SFML/Graphics.hpp>
#include <cmath>
#include <string>

#include "epidemic_SIR_2.hpp"
...
class Display {
 ...
 public:
  ...
  void draw_canvas(double days, std::vector<Population> const& data) {
