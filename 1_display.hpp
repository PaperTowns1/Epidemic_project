...
class Display {
 ...
 public:
  ...
  void draw_more(std::vector<epidemic_SIR::Population> const& data) {
  ...
  void draw_more(std::vector<epidemic_SIRD::Population> const& data) {
    int const distance_values = m_display_size * 0.7 / 10;
    int const N = data[0].s + data[0].i + data[0].r + data[0].d;
    int const days = data.size();
    ...
    sf::Text susceptible, infectious, recovered, deceased;

    susceptible.setFont(m_font);
    infectious.setFont(m_font);
    recovered.setFont(m_font);
    deceased.setFont(m_font);
    susceptible.setString("S");
    infectious.setString("I");
    recovered.setString("R");
    deceased.setString("D");
    susceptible.setCharacterSize(m_display_size / 40);
    infectious.setCharacterSize(m_display_size / 40);
    recovered.setCharacterSize(m_display_size / 40);
    deceased.setCharacterSize(m_display_size / 40);
    susceptible.setFillColor(sf::Color::Black);
    infectious.setFillColor(sf::Color::Black);
    recovered.setFillColor(sf::Color::Black);
    deceased.setFillColor(sf::Color::Black);
    ...
    recovered.setPosition(
        sf::Vector2f(m_display_size * 0.57, m_display_size * 0.115));
    deceased.setPosition(
        sf::Vector2f(m_display_size * 0.77, m_display_size * 0.055));

    m_window.draw(susceptible);
    m_window.draw(infectious);
    m_window.draw(recovered);
    m_window.draw(deceased);

    sf::VertexArray color(sf::Lines, 8);
    ...
    color[5].position =
        sf::Vector2f(m_display_size * 0.7, m_display_size * 0.134);
    color[6].position =
        sf::Vector2f(m_display_size * 0.8, m_display_size * 0.066);
    color[7].position =
        sf::Vector2f(m_display_size * 0.9, m_display_size * 0.066);
    ...
    color[4].color = sf::Color::Green;
    color[5].color = sf::Color::Green;
    color[6].color = sf::Color::Black;
    color[7].color = sf::Color::Black;
  ...
  void draw_susceptible(std::vector<epidemic_SIR::Population> const& data) {
  ...
  void draw_infectious(std::vector<epidemic_SIR::Population> const& data) {
  ...
  void draw_recovered(std::vector<epidemic_SIR::Population> const& data) {
  ...
  void draw_susceptible(std::vector<epidemic_SIRD::Population> const& data) {
    sf::VertexArray points_s(sf::LineStrip, data.size());
  ...
  void draw_infectious(std::vector<epidemic_SIRD::Population> const& data) {
    sf::VertexArray points_i(sf::LineStrip, data.size());
  ...
  void draw_recovered(std::vector<epidemic_SIRD::Population> const& data) {
    sf::VertexArray points_r(sf::LineStrip, data.size());
  ...
  void draw_deceased(std::vector<epidemic_SIRD::Population> const& data) {
    sf::VertexArray points_r(sf::LineStrip, data.size());
    ...
    for (int i{0}; i != n; ++i) {
      points_r[i].position = sf::Vector2f(
          i * m_display_size * 0.7 / n + m_display_size * 0.15,
          data[i].d / N * m_display_size * 0.7 + m_display_size * 0.1);
    }

    for (int i{0}; i != n; ++i) {
      points_r[i].color = sf::Color::Black;
    }
